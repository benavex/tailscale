...
func newSetFlagSet(goos string, setArgs *setArgsT) *flag.FlagSet {
	...
	setf.StringVar(&setArgs.exitNodeIP, "exit-node", "", "Tailscale exit node (IP, base name, auto:any, or auto:follow-crown) for internet traffic, or empty string to not use an exit node")
